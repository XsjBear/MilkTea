...
<body>
	...
	<input id="flag" name="flag" value="file_System" type="hidden" />
	...
	<div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
		...
		<ul style="margin-right: 0;" class="nav navbar-nav navbar-right">
			<!-- 个人头像 -->
			<li>
				<!-- 头像图片以及相关信息 --> <a data-toggle="dropdown"
				class="dropdown-toggle" href="#"> <img alt=""
					class="admin-pic img-circle" src="img/default_headImg.png">${User.username }
					<b class="caret"></b>
			</a> <!-- 下拉列表 -->
				<ul style="margin-top: 14px;" role="menu"
					class="dropdown-setting dropdown-menu">
					<li><a href="#"> <span onclick="changeVale(self_Page)" class="entypo-user"></span>&#160;&#160;我的主页
					</a></li>
					<li><a href="#"> <span class="entypo-vcard"></span>&#160;&#160;我的个人信息
					</a></li>
					<li><a href="#"> <span class="entypo-lifebuoy"></span>&#160;&#160;帮助
					</a></li>
					<li class="divider"></li>
					<li><a
						href="http://themeforest.net/item/apricot-navigation-admin-dashboard-template/7664475?WT.ac=category_item&WT.z_author=themesmile">
							<span class="entypo-basket"></span>&#160;&#160; 收藏文件
					</a></li>
				</ul>
			</li>
			<!-- 主题设置 -->
			<li><a data-toggle="dropdown" class="dropdown-toggle" href="#">
					<span class="icon-gear"></span>&#160;&#160;主题设置
			</a>
			...
			<!-- 右呼出栏 -->
			<li class="hidden-xs"><a class="toggle-left"
				href="#sb-slidebar sb-right"> <span style="font-size: 20px;"
					class="entypo-list-add"></span>
			</a></li>
				...
				<div class="side-bar">
					...
					<ul id="menu-showhide" class="topnav menu-left-nest">
						...
						<li><a class="tooltip-tip" href="#" title="Form"> <i
							...
							<ul>
								...
								<li><a class="tooltip-tip2 ajax-load" href="#paper-middle"
									title="Andvance Form"><i class="icon-map"></i><span>修改个人信息</span></a>
								</li>
								<li><a class="tooltip-tip2 ajax-load"
					...
					<div class="side-dash">
						...
						<ul class="side-bar-list">
							<li>Avg. Traffic
								<div class="linebar">5,7,8,9,9,5,3,8,5</div>
							</li>
							<li>Visitors
		...
		<div class="container-fluid paper-wrap bevel tlbr">
				...
				<div id="paper-top">
					...
					<div class="col-lg-3">
						<h2 class="tittle-content-header">
							<i class="icon-window"></i> <span>个人文件 </span>
						</h2>
					</div>
			...
			<div id="paper-middle">
				<div id="mapContainer">
					...
					<h1>${param.flag == file_System}</h1>
					<c:if test="${param.flag == file_System}">
						<h1>这是中间的空白</h1>
					</c:if>
				...
				<div class="row">
					...
					<div class="col-lg-3">
						<div class="profit" id="profitClose">
							<div class="headline ">
								<h3>
									<span> <i class="maki-ferry"></i>&#160;&#160;Ferry
										Arrival
									</span>
								</h3>
								<div class="titleClose">
									<a href="#profitClose" class="gone"> <span
							...
							<div class="value">
								<span class="pull-left"><i
									class="entypo-clock clock-position"></i> </span>
							...
							<div class="profit-line">
								<i class="fa fa-caret-up fa-lg"></i>&#160;&#160; 50% &#160;From
								Last Hour
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3">
						<div class="revenue" id="revenueClose">
							<div class="headline ">
								<h3>
									<span> <i class="maki-aboveground-rail"></i>&#160;&#160;Train
										Speed
									</span>
								</h3>

								<div class="titleClose">
									<a href="#revenueClose" class="gone"> <span
										class="entypo-cancel"></span>
									</a>
								</div>
							</div>
							<div class="value">
								<span class="pull-left"><i
									class="entypo-gauge gauge-position"></i> </span>
							...
							<div class="profit-line">
								<i class="fa fa-caret-down fa-lg"></i>&#160;&#160;Rate : 20
								km/Hour
							</div>
						</div>
					</div>
				...
				<div class="row">
										...
										<tbody>
											...
											<tr>
												<td class="armada-devider">
													<div class="armada">
														<span style="background: #65C3DF"> <span
															class="maki-bus"></span>&nbsp;&nbsp;Trans Berlin
														</span>
														<p>
												...
												<td class="driver-devider"><img
													class="armada-pic img-circle" alt=""
													src="http://api.randomuser.me/portraits/thumb/men/14.jpg">
													<h3>Mark Zukenbeirg</h3> <br>
													<p>Driver</p></td>

												<td class="progress-devider"><section id="basic">
													<article>
													...
													</article> </section> <span class="label pull-left">Berlin</span> <span
													class="label pull-right">Muchen</span></td>
											</tr>
					...
					<div class="col-lg-4">
						<div id="RealTimeClose" class="nest">
							...
							<div id="RealTime" style="min-height: 296px; padding-top: 20px;"
								class="body-nest">
								<ul class="direction">
									<li><span class="direction-icon maki-fuel"
										...
										<p>
											<i>Estimated time </i>:&nbsp;<i class="fa fa-clock-o"></i>&nbsp;&nbsp;20
											Min
										</p></li>
									<!-- 分割线 -->
									<li class="divider"></li>

									<li><span class="direction-icon maki-fast-food"
										style="background: #65C3DF"></span>
										<h3>
									...
									<li><span class="direction-icon maki-giraffe"
										style="background: #45B6B0"></span>
										<h3>
											<span>Zoo</span>
										</h3>
										<p>
